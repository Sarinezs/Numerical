    ...
    Cal_Gauss_jordan = () =>{
        ...
        for(let i = 0; i<size; i++){ // เก็บarray
            ...
            for(let j = 0; j<size; j++){
                ...
                a_check[i].push(document.getElementById("input"+i+j).value);
            }     
            b.push([]);   
        ...
        for(var i = 0; i<size; i++){ // สร้างพื้นที่ที่ไว้แสดงผลคำตอบ
            area_for_b += "<div style='margin-bottom: 10px;'><br/>"+"b"+(i+1)+" = <h id='ans_b"+i+0+"'> </h></div>";
        }
        ...
        for(var i = 0; i<size; i++){
            area_check_ans += "<div style='margin-bottom: 10px;'>"+"x"+(i+1)+" = <h id='ans_c"+i+0+"'> </h></div>"
        }
        document.getElementById("area_c").innerHTML=area_check_ans;
        
        for(var i = 0; i<size; i++){
            document.getElementById("ans_c"+i+0).innerHTML=ans_check[i];
        }  
            ...
            <div>
                <div style={mainDiv}>
                    <div style={Div}>
                        ...
                        <div id="area_b" style={{marginBottom: "10%"}}></div>

                        <h> Answer Check </h><br/>

                        <div id="area_c" style={{marginBottom: "10%"}}></div>
